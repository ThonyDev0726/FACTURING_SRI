...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        add(title);
        description = new JLabel("Activa tu producto y se parte de una gran experiencia!!");
    ...
    private void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                ...
                button.setText("ACTIVAR PRODUCTO");
            } else {
                title.setText("¡Bienvenido a Facturing!");
                description.setText("Activa tu producto y se parte de una gran experiencia!!");
                description1.setText("");
                button.setText("CONTACTANOS");
            }
            this.isLogin = login;
