package com.anthony.slider.slideShow;
...
public class Slideshow extends JLayeredPane {
    ...
    public Slideshow() {
        ...
        setLayout(new MigLayout("fill, inset 0", "[fill, center]", "0[fill]0"));
        add(pagination, "pos 0.5al 1al n n");
        add(panel, "w 100%-6!");
        timer = new Timer(4000, new ActionListener() {//tiempo para cambiar de slider
            @Override
