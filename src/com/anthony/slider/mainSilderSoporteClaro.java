 ...
 */
public class mainSilderSoporteClaro extends javax.swing.JPanel {

    public mainSilderSoporteClaro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        button1.setBackground(new java.awt.Color(233, 233, 233));
        ...
        button4.setBackground(new java.awt.Color(233, 233, 233));
        button4.setForeground(new java.awt.Color(102, 153, 255));
        button4.setText("<");
