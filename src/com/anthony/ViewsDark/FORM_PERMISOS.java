...
public class FORM_PERMISOS extends javax.swing.JPanel {
    ...
    public FORM_PERMISOS(USUARIO usu, MainAdministradorDark admin) {
        initComponents();
        this.admin = admin;
        this.usu = usu;
        tablaUsuarios();
...
//        contarRegistros();
    ...
    private void initComponents() {
        ...
        sp.setBackground(new java.awt.Color(22, 23, 23));
        sp.setBorder(null);

        jPanel1.setBackground(new java.awt.Color(22, 23, 23));

        panelPermisos.setBackground(new java.awt.Color(32, 32, 32));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(108, 95, 70));
        jLabel2.setText("USUARIO:");

        usuNombres.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        usuNombres.setForeground(new java.awt.Color(0, 153, 204));
        ...
        jLabel3.setForeground(new java.awt.Color(108, 95, 70));
        jLabel3.setText("OBSERVACION:");

        usuCedula.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        usuCedula.setForeground(new java.awt.Color(0, 153, 204));
        ...
        roundPanel2Layout.setVerticalGroup(
            ...
            .addGroup(roundPanel2Layout.createSequentialGroup()
                .addGap(3, 3, 3)
                .addComponent(spUsuarios, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
                .addGap(3, 3, 3))
        );
        ...
        jLabel23.setForeground(new java.awt.Color(96, 96, 96));
