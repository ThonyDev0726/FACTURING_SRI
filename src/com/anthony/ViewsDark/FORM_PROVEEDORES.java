...
public class FORM_PROVEEDORES extends javax.swing.JPanel {
    ...
    public FORM_PROVEEDORES(USUARIO usu, MainAdministradorDark admin) {
        initComponents();
        this.admin = admin;
        this.usu = usu;
        scroll();
...
//        contarRegistros();
    ...
    private void initComponents() {
        ...
        roundPanel1Layout.setVerticalGroup(
            ...
            .addGroup(roundPanel1Layout.createSequentialGroup()
                .addGap(3, 3, 3)
                .addComponent(spProveedores, javax.swing.GroupLayout.DEFAULT_SIZE, 229, Short.MAX_VALUE)
                .addGap(3, 3, 3))
        );
        ...
        txtContacto.setBackground(new java.awt.Color(32, 32, 32));
        txtContacto.setForeground(new java.awt.Color(0, 153, 204));
        txtContacto.setLabelText("Contacto");

        txtEmpresa.setBackground(new java.awt.Color(32, 32, 32));
        ...
        txtWeb.setBackground(new java.awt.Color(32, 32, 32));
