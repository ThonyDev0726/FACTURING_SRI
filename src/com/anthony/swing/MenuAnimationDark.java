...
import com.anthony.componentsDark.MenuItemDark;
...
public class MenuAnimationDark {

    private final MigLayout layout;
    private  MenuItemDark menuItem;
    private Animator animator;
    private boolean open;

    public MenuAnimationDark(MigLayout layout, Component component) {
        this.layout = layout;
        this.menuItem =  (MenuItemDark) component;
        initAnimator(component, 200);
    }

    public MenuAnimationDark(MigLayout layout, Component component, int duration) {
        this.layout = layout;
        this.menuItem = (MenuItemDark) component;
