package com.anthony.componentPrecios;

import com.anthony.shadow.ShadowRenderer;
...
public class PanelDetail extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdBuy.setBorder(null);
        cmdBuy.setText("Buy Now");
        cmdBuy.setBorderPainted(false);
        cmdBuy.setFocusPainted(false);
        ...
        jLayeredPane1Layout.setVerticalGroup(
            ...
            .addGroup(jLayeredPane1Layout.createSequentialGroup()
                ...
                .addComponent(cmdBuy, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        f.curveTo(width - radius, 0, width, 0, width, radius);
        f.lineTo(width, height - radius);
        f.curveTo(width, height - radius, width, height, width - radius, height);
        f.lineTo(0, height);
        g2.fill(f);
        int px[] = {0, 25, 25};
