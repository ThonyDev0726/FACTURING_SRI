...
public class MenuItemLigth extends javax.swing.JPanel {
    ...
    public MenuItemLigth(ModelMenu menu, EventMenu event, EventMenuSelected eventSelected, int index) {
        initComponents();
        this.menu = menu;
        this.eventSelected = eventSelected;
        this.index = index;
        ...
        firstItem.setForeground(new Color(155, 186, 248));
        firstItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                if (menu.getSubMenu().length > 0) {
                    if (event.menuPressed(MenuItemLigth.this, !open)) {
                        open = !open;
                    }
                }
