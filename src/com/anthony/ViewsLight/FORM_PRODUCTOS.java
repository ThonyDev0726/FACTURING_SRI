...
public class FORM_PRODUCTOS extends javax.swing.JPanel {
    ...
    public FORM_PRODUCTOS(USUARIO usu, MainAdministrador admin) {
        initComponents();
        this.admin = admin;
        this.usu = usu;
        scroll();
...
//        contarRegistros();
    ...
    private void calculo() {
        ...
        PRO_PVP = ((PRO_GANANCIA * Double.parseDouble(txtValorFabrica.getText())) / 100) + Double.parseDouble(txtValorFabrica.getText());
//        PRO_PVP = Double.parseDouble(df.format(PRO_PVP));
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(234, 241, 251));
        ...
        tDatosProductos.setForeground(new java.awt.Color(234, 241, 251));
        ...
        tDatosProductos.setSelectionBackground(new java.awt.Color(255, 255, 255));
        ...
        tDatosProveedores.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tDatosProveedores.setColorBordeFilas(new java.awt.Color(255, 255, 255));
        tDatosProveedores.setColorBordeHead(new java.awt.Color(255, 255, 255));
        ...
        panelProveedoresLayout.setHorizontalGroup(
            ...
            .addComponent(spProveedores, javax.swing.GroupLayout.DEFAULT_SIZE, 687, Short.MAX_VALUE)
        ...
        panelProveedoresLayout.setVerticalGroup(
            ...
            .addGroup(panelProveedoresLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(spProveedores, javax.swing.GroupLayout.DEFAULT_SIZE, 332, Short.MAX_VALUE)
                .addGap(3, 3, 3))
        );
        ...
        txtValorFabrica.setBackground(new java.awt.Color(255, 255, 255));
        ...
        txtCodAuxiliar.setBackground(new java.awt.Color(255, 255, 255));
        ...
        panelFormLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {cbxEstado, cbxGanancia, cbxSucursal, txtCategoria, txtCodAuxiliar, txtCodPrinc, txtDetalle, txtDetalleExtra, txtNombre, txtPVP, txtProveedor, txtStock, txtValorFabrica});
    ...
    private void txtPVPMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtPVPMouseClicked
        if (txtValorFabrica.getText().length() == 0) {
            panel = new Toast(admin, Toast.Type.INFO, Toast.Location.BOTTOM_RIGHT, "Debes dar un valor de fabrica al producto");
            panel.showNotification();
        } else {
            calculo();
        }
