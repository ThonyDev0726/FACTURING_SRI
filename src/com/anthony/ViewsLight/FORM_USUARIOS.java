...
public class FORM_USUARIOS extends javax.swing.JPanel {
    ...
    public FORM_USUARIOS(USUARIO usu, MainAdministrador admin) {
        initComponents();
        this.admin = admin;
        this.usu = usu;
        scroll();
    ...
    private void scroll() {
        ...
        spEmpleados.setHorizontalScrollBar(new ScrollBarCustomClaro());
...
//        contarRegistros();
    ...
    private void initComponents() {
        ...
        tabbedPanel.setForeground(new java.awt.Color(7, 16, 17));
        ...
        tDatosUsuarios.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tDatosUsuarios.setColorFilasBackgound2(new java.awt.Color(248, 248, 248));
        tDatosUsuarios.setColorFilasForeground1(new java.awt.Color(150, 160, 175));
        tDatosUsuarios.setColorFilasForeground2(new java.awt.Color(150, 160, 175));
        tDatosUsuarios.setColorForegroundHead(new java.awt.Color(7, 16, 17));
        ...
        tDatosUsuarios.setOpaque(false);
        ...
        txtBusquedaEmpleado.setBackground(new java.awt.Color(255, 255, 255));
        ...
        rdtbNombres.setForeground(new java.awt.Color(7, 16, 17));
        ...
        rdtbApellidos.setForeground(new java.awt.Color(7, 16, 17));
        ...
        rdtbCedula.setForeground(new java.awt.Color(7, 16, 17));
        ...
        panelEmpleadosLayout.setVerticalGroup(
            ...
            .addGroup(panelEmpleadosLayout.createSequentialGroup()
                ...
                .addGroup(panelEmpleadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jLabel12))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(spEmpleados, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
                .addGap(3, 3, 3))
        );
        ...
        txtEmpNombres.setBackground(new java.awt.Color(255, 255, 255));
        ...
        txtEmpApellidos.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(roundPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE)
                .addContainerGap())
        );
