...
public class FORM_EMPLEADOS extends javax.swing.JPanel {
    ...
    public FORM_EMPLEADOS(MainAdministrador admin, USUARIO usu) {
        initComponents();
        this.admin = admin;
        this.usu = usu;
        scroll();
...
//        contarRegistros();
    ...
    private void initComponents() {
        ...
        lblRecargar.setForeground(new java.awt.Color(102, 153, 255));
        ...
        spPrincipal.setBackground(new java.awt.Color(255, 255, 255));
        spPrincipal.setBorder(null);
        spPrincipal.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tDatosEmpleados.setBackground(new java.awt.Color(246, 247, 251));
        tDatosEmpleados.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tDatosEmpleados.setColorBordeHead(new java.awt.Color(7, 6, 17));
        ...
        tDatosEmpleados.setColorForegroundHead(new java.awt.Color(7, 6, 17));
        tDatosEmpleados.setColorSelBackgound(new java.awt.Color(224, 237, 255));
        tDatosEmpleados.setColorSelForeground(new java.awt.Color(102, 102, 102));
        ...
        btnNuevoRegistro.setForeground(java.awt.Color.white);
        ...
        btnActualizarEmp.setBackground(new java.awt.Color(235, 190, 25));
        ...
        txtEmpTelefono.setBackground(new java.awt.Color(255, 255, 255));
        ...
        txtEmpCedula.setBackground(new java.awt.Color(255, 255, 255));
        ...
        txtEmpDireccion.setBackground(new java.awt.Color(255, 255, 255));
        ...
        txtEmpEmail.setBackground(new java.awt.Color(255, 255, 255));
