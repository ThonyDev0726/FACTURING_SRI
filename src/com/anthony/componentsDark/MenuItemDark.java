...
import com.anthony.swing.MenuButton;
...
public class MenuItemDark extends javax.swing.JPanel {


    public ModelMenuDark getMenu() {
        return menu;
    }
    ...
    public EventMenuSelectedDark getEventSelected() {
        return eventSelected;
    }

    public void setEventSelected(EventMenuSelectedDark eventSelected) {
    ...
    private float alpha;
    private ModelMenuDark menu;
    private boolean open;
    private EventMenuSelectedDark eventSelected;
    private int index;

    public MenuItemDark(ModelMenuDark menu, EventMenuDark event, EventMenuSelectedDark eventSelected, int index) {
        initComponents();
        this.menu = menu;
        this.eventSelected = (EventMenuSelectedDark) eventSelected;
        this.index = index;
        setOpaque(false);
        ...
        firstItem.setToolTipText(menu.getMenuName());
        firstItem.setForeground(new Color(74, 97, 124));
        firstItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                if (menu.getSubMenu().length > 0) {
                    if (event.menuPressed(MenuItemDark.this, !open)) {
                        open = !open;
                    }
                }
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        g2.setColor(new Color(23, 25, 27));
