...
public class Toast extends javax.swing.JComponent {
    ...
    public Toast(Frame fram, Type type, Location location, String message) {
        this.fram = fram;
        this.type = type;
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/anthony/toast/imgExito.png")));
            lbMessage.setText("Éxito!");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/anthony/toast/imgInformacion.png")));
            lbMessage.setText("Información");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/anthony/toast/imgError.png")));
    ...
    public void paint(Graphics grphcs) {
        ...
        if (type == Type.SUCCESS) {
            ...
            g2.setColor(new Color(255, 41, 0));
        }
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/anthony/toast/imgExito.png"))); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/anthony/toast/imgCerrar.png"))); // NOI18N
