...
CREATE PROCEDURE SELECT_PRODUCTOS_FACTURACION()
BEGIN
    SELECT 
        ID_PRODUCTO,
        PRO_NOMBRE,
...
CREATE PROCEDURE INSERT_PRODUCTO(    
    ...
    IN PRO_TIPO_IVA_V VARCHAR(20),
    IN PRO_DESCUENTO_V DECIMAL(10,3)
)
BEGIN
...
CREATE PROCEDURE SELECT_PRODUCTO_BUSCAR_FACTURACION(IN pcriterio VARCHAR(20), IN pbusqueda VARCHAR(55))
BEGIN
	IF pcriterio = "PRO_NOMBRE" THEN
        SELECT 
        ID_PRODUCTO,
...
-- PROCEDIMIENTOS FACTURAS TOTALIDAD
-- =========================================================================
CREATE PROCEDURE SELECT_LICENCIA_ESTADO()
BEGIN
    SELECT LIC_ESTADO FROM LICENCIAS WHERE ID_LICENCIA = 1;
END;

CREATE PROCEDURE SELECT_LICENCIA_ID(
    IN LIC_CLAVE_V VARCHAR(75)
)
BEGIN
    SELECT COUNT(LIC_CLAVE) FROM LICENCIAS WHERE LIC_CLAVE = LIC_CLAVE_V;
END;

CREATE PROCEDURE UPDATE_LICENCIA()
BEGIN
