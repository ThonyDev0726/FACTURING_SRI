...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2023 a las 14:58:11
...
(1, 1, 'Richard Anthony', 'Perez Palacios', '1723382592', 'richardanto0726@gmail.com', '0987456321', 'Quito, Ecuador', 'EN LINEA', '2023-01-20');
...
(1, 'APP - SOFT', 'RICHARD ANTHONY PEREZ PALACIOS', '1723382592001', 'Av. Guayanay Ñan Oe2-113, Quito 170702', 'Av. Guayanay Ñan Oe2-113, Quito 170702', 726, 54321, 54321, 12345678, 'SI', 'SI', 'SD - BioPass3000');
...
(1, 1, 'Sucursal 01', '0987456321', 'appsoft@gmail.com', 'Quito, Ecuador', 'EN LINEA');
...
(1, 1, 1, 'Admin', 'LFPfLv8ji08=', 'Administrador', 'EN LINEA', '2023-01-20');
...
--
ALTER TABLE `factura_totalidad`
  MODIFY `ID_TOTALIDAD` int(11) NOT NULL AUTO_INCREMENT;
